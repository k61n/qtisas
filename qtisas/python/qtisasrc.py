...
def import_to_global(modname, attrs=None, math=False):
    """
    import_to_global(modname, (a,b,c,...), math): like "from modname import a,
    b, c, ...", but imports to global namespace (__main__).
...
if __name__ == '__main__':
    ...
    appImports = [
        "table", "newTable", "matrix", "newMatrix", "graph", "newGraph",
        "note", "newNote", "newPlot3D",
        ...
        "activeFolder", "rootFolder", "addFolder", "deleteFolder",
        "changeFolder", "copyFolder", "saveFolder",
        "appendProject", "saveProjectAs",
    ...
    try:
        special_functions = [
            ...
            # Bessel Functions
            "jn", "jv", "jve", "yn", "yv", "yve", "kn", "kv", "kve", "iv",
            "ive", "hankel1", "hankel1e", "hankel2", "hankel2e", "lmbda",
            "jnjnp_zeros", "jnyn_zeros", "jn_zeros", "jnp_zeros",
            "yn_zeros", "ynp_zeros", "y0_zeros", "y1_zeros", "y1p_zeros",
            "j0", "j1", "y0", "y1", "i0", "i0e", "i1", "i1e", "k0", "k0e", "k1",
            "k1e",
            ...
            "gamma", "gammaln", "gammainc", "gammaincinv", "gammaincc",
            "gammainccinv", "beta", "betaln", "betainc", "betaincinv",
            "psi", "rgamma", "polygamma",
            # Error Function and Fresnel Integrals
            "erf", "erfc", "erfinv", "erfcinv", "erf_zeros", "fresnel",
            "fresnel_zeros", "fresnelc_zeros", "fresnels_zeros",
            "modfresnelp", "modfresnelm",
            # Legendre Functions
            ...
            "mathieu_cem", "mathieu_sem", "mathieu_modcem1", "mathieu_modcem2",
            "mathieu_modsem1", "mathieu_modsem2",
            # Spheroidal Wave Functions
            "pro_ang1", "pro_rad1", "pro_rad2", "obl_ang1", "obl_rad1",
            "obl_rad2", "pro_cv", "obl_cv", "pro_cv_seq", "obl_cv_seq",
            "pro_ang1_cv", "pro_rad1_cv", "pro_rad2_cv",
            "obl_ang1_cv", "obl_rad1_cv", "obl_rad2_cv",
            # Kelvin Functions
            "kelvin", "kelvin_zeros",
            "ber", "bei", "berp", "beip", "ker", "kei", "kerp", "keip",
            "ber_zeros", "bei_zeros", "berp_zeros", "beip_zeros", "ker_zeros",
            "kei_zeros", "kerp_zeros", "keip_zeros",
            # Other Special Functions
            "expn", "exp1", "expi", "wofz", "dawsn", "shichi", "sici", "spence",
            "zeta", "zetac",
            # Convenience Functions
            "cbrt", "exp10", "exp2", "radian", "cosdg", "sindg", "tandg",
            "cotdg", "log1p", "expm1", "cosm1", "round",]
    ...
    try:
        ...
        print("Sympy module successfully imported: "
              "SymPy is a Python library for symbolic mathematics.\n"
              "If you are new to SymPy, "
              "start with the documentation: http://docs.sympy.org/\n")
    except ImportError:
        pass
