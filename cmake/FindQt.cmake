...
if (${PREFER_QT})
    if (${PREFER_QT} EQUAL 6)
        set(QT_MODULES Core DBus Network OpenGLWidgets PrintSupport Svg Xml Widgets Concurrent)
    elseif (${PREFER_QT} EQUAL 5)
        set(QT_MODULES Core Network OpenGL PrintSupport Svg Xml Widgets Concurrent)
    endif ()
    set(V ${PREFER_QT})
