...
const muParserScripting::mathFunction muParserScripting::math_functions[] = {
    {QString("abs").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("abs(x):\n Absolute value of x.")},
    {QString("acos").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("acos(x):\n Inverse cos function.")},
    {QString("acosh").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("acosh(x):\n Hyperbolic inverse cos function.")},
    {QString("asin").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("asin(x):\n Inverse sin function.")},
    {QString("asinh").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("asinh(x):\n Hyperbolic inverse sin function.")},
    {QString("atan").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("atan(x):\n Inverse tan function.")},
    {QString("atanh").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("atanh(x):\n  Hyperbolic inverse tan function.")},
    {QString("avg").toUtf8().data(), -1, nullptr, nullptr, nullptr,
     QObject::tr("avg(x,y,...):\n  Mean value of all arguments.")},
    {QString("bessel_i0").toUtf8().data(), 1, bessel_I0, nullptr, nullptr,
     QObject::tr("bessel_i0(x):\n  Regular modified cylindrical Bessel function of zeroth order, I_0(x).")},
    {QString("bessel_i1").toUtf8().data(), 1, bessel_I1, nullptr, nullptr,
     QObject::tr("bessel_i1(x):\n  Regular modified cylindrical Bessel function of first order, I_1(x).")},
    {QString("bessel_in").toUtf8().data(), 2, nullptr, bessel_In, nullptr,
     QObject::tr("bessel_in(double x, int n):\n Regular modified cylindrical Bessel function of order n, I_n(x).")},
    {QString("bessel_j0").toUtf8().data(), 1, bessel_J0, nullptr, nullptr,
     QObject::tr("bessel_j0(x):\n  Regular cylindrical Bessel function of zeroth order, J_0(x).")},
    {QString("bessel_j1").toUtf8().data(), 1, bessel_J1, nullptr, nullptr,
     QObject::tr("bessel_j1(x):\n  Regular cylindrical Bessel function of first order, J_1(x).")},
    {QString("bessel_jn").toUtf8().data(), 2, nullptr, bessel_Jn, nullptr,
     QObject::tr("bessel_jn(double x, int n):\n Regular cylindrical Bessel function of order n, J_n(x).")},
    {QString("bessel_jn_zero").toUtf8().data(), 2, nullptr, bessel_Jn_zero, nullptr,
    ...
    {QString("erf").toUtf8().data(), 1, erf, nullptr, nullptr, QObject::tr("erf(x):\n  The error function.")},
    {QString("erfc").toUtf8().data(), 1, erfc, nullptr, nullptr,
     QObject::tr("erfc(x):\n Complementary error function erfc(x) = 1 - erf(x).")},
    {QString("erfz").toUtf8().data(), 1, erf_Z, nullptr, nullptr,
     QObject::tr("erfz(x):\n The Gaussian probability density function Z(x).")},
    {QString("erfq").toUtf8().data(), 1, erf_Q, nullptr, nullptr,
     QObject::tr("erfq(x):\n The upper tail of the Gaussian probability function Q(x).")},
    {QString("exp").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("exp(x):\n Exponential function: e raised to the power of x.")},
    {QString("floor").toUtf8().data(), 1, floor, nullptr, nullptr,
     QObject::tr("floor(x):\n Round to the next smaller integer,\n largest integer smaller or equal to x.")},
    {QString("ftable").toUtf8().data(), 3, nullptr, nullptr, ftable,
     QObject::tr("ftable(x, m, n):\n F-Distribution with m and n degrees of freedom.")},
    {QString("gamma").toUtf8().data(), 1, gamma, nullptr, nullptr,
     QObject::tr("gamma(x):\n Computes the Gamma function, subject to x not being a negative integer.")},
    {QString("gammaln").toUtf8().data(), 1, lngamma, nullptr, nullptr,
    ...
    {QString("gauss_cdf").toUtf8().data(), 2, nullptr, gauss_cdf, nullptr,
     QObject::tr("gauss_cdf(x, sigma):\n Computes the cumulative distribution function for a Gaussian distribution "
                 "with standard deviation sigma.")},
    {QString("gauss_pdf").toUtf8().data(), 2, nullptr, gauss_pdf, nullptr,
     QObject::tr("gauss_pdf(x, sigma):\n Computes the probability density at x for a Gaussian distribution with "
                 "standard deviation sigma.")},
    {QString("hazard").toUtf8().data(), 1, hazard, nullptr, nullptr,
     QObject::tr("hazard(x):\n Computes the hazard function for the normal distribution h(x) = erfz(x)/erfq(x).")},
    {QString("if").toUtf8().data(), 3, nullptr, nullptr, nullptr,
     QObject::tr("if(e1, e2, e3):\n if e1 then e2 else e3.")},
    {QString("inv_gauss_cdf").toUtf8().data(), 2, nullptr, inv_gauss_cdf, nullptr,
    ...
    {QString("invf").toUtf8().data(), 3, nullptr, nullptr, invf,
     QObject::tr("invf(x, m, n):\n Inverse F-Distribution with m and n degrees of freedom.")},
    {QString("invt").toUtf8().data(), 2, nullptr, invt, nullptr,
     QObject::tr("invt(x, n):\n Inverse t-distribution with n degrees of freedom.")},
    {QString("ln").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("ln(x):\n Calculate natural logarithm log_e.")},
    {QString("log").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("log(x):\n Calculate decimal logarithm log_10.")},
    {QString("log10").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("log10(x):\n Calculate decimal logarithm log_10.")},
    {QString("log2").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("log2(x):\n Calculate binary logarithm log_2.")},
    {QString("min").toUtf8().data(), -1, nullptr, nullptr, nullptr,
     QObject::tr("min(x,y,...):\n Calculate minimum of all arguments.")},
    {QString("max").toUtf8().data(), -1, nullptr, nullptr, nullptr,
     QObject::tr("max(x,y,...):\n Calculate maximum of all arguments.")},
    {QString("mod").toUtf8().data(), 2, nullptr, mod, nullptr,
     QObject::tr("mod(x,y):\n Calculate rest of integer division x/y,\n x modulo y.")},
    {QString("normal").toUtf8().data(), 1, normal, nullptr, nullptr,
     QObject::tr("normal(seed):\n Returns a normal random number using the Ziggurat algorithm.")},
    {QString("normcdf").toUtf8().data(), 1, normcdf, nullptr, nullptr,
    ...
    {QString("norminv").toUtf8().data(), 1, norminv, nullptr, nullptr,
    ...
    {QString("pow").toUtf8().data(), 2, nullptr, pow, nullptr,
     QObject::tr("pow(x,y):\n Raise x to the power of y, x^y.")},
    {QString("rint").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("rint(x):\n Round to nearest integer.")},
    {QString("rnd").toUtf8().data(), 1, rnd, nullptr, nullptr,
    ...
    {QString("sign").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("sign(x):\n Sign function: -1 if x<0; 1 if x>0.")},
    {QString("sin").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("sin(x):\n Calculate sine.")},
    {QString("sinh").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("sinh(x):\n Hyperbolic sin function.")},
    {QString("sqrt").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("sqrt(x):\n Square root function.")},
    {QString("sum").toUtf8().data(), -1, nullptr, nullptr, nullptr,
     QObject::tr("sum(x,y,...):\n Calculate sum of all arguments.")},
    {QString("tan").toUtf8().data(), 1, nullptr, nullptr, nullptr,
     QObject::tr("tan(x):\n Calculate tangent function.")},
    {QString("tanh").toUtf8().data(), 1, nullptr, nullptr, nullptr, QObject::tr("tanh(x):\n Hyperbolic tan function.")},
    {QString("ttable").toUtf8().data(), 2, nullptr, ttable, nullptr,
     QObject::tr("ttable(x, n):\n Student's t-distribution with n degrees of freedom.")},
    {QString("w0").toUtf8().data(), 1, lambert_W0, nullptr, nullptr,
    ...
    {QString("wm1").toUtf8().data(), 1, lambert_Wm1, nullptr, nullptr,
