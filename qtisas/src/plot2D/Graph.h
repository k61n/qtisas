...
class Graph: public QwtPlot
{
	...
	public:
    explicit Graph(int x = 0, int y = 0, int width = 500, int height = 400, QWidget *parent = nullptr,
    ...
    DataCurve *insertCurveScatter(const QString &curveName, bool replotForce = true);
    ...
    void setScale(int axis, double start, double end, double step = 0.0, int majorTicks = 5, int minorTicks = 5,
                  ...
                  int minTicksAfterBreak = 4, int typeAfterBreak = 0, int breakWidth = 4, bool breakDecoration = true);
