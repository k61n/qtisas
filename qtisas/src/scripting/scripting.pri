...
INCLUDEPATH += \
    $${QTISAS_FOLDER}/qtisas/src/scripting/ \
    $${QTISAS_FOLDER}/qtisas/sans/compile/

HEADERS += \
    $${QTISAS_FOLDER}/qtisas/src/scripting/customevents.h \
...
SOURCES += \
    $${QTISAS_FOLDER}/qtisas/src/scripting/FindReplaceDialog.cpp \
...
contains(SCRIPTING_LANGS, muParser) {
    ...
    HEADERS += \
        $${QTISAS_FOLDER}/qtisas/src/scripting/muParserScript.h \
        $${QTISAS_FOLDER}/qtisas/src/scripting/muParserScripting.h \

    SOURCES += \
        $${QTISAS_FOLDER}/qtisas/src/scripting/muParserScript.cpp \
...
contains(SCRIPTING_LANGS, Python) {
    ...
    HEADERS += \
        $${QTISAS_FOLDER}/qtisas/src/scripting/PythonScript.h \
        $${QTISAS_FOLDER}/qtisas/src/scripting/PythonScripting.h \
        $${SIP_DIR}/sipAPIqti.h

    SOURCES += \
        $${QTISAS_FOLDER}/qtisas/src/scripting/PythonScript.cpp \
        $${QTISAS_FOLDER}/qtisas/src/scripting/PythonScripting.cpp \

    SOURCES += \
        $${SIP_DIR}/sipqticmodule.cpp \
