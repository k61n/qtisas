...
struct tamu_anova_table tamu_anova(double data[], long factor[], long I, long J)
{
    ...
    long *n = malloc(J * sizeof(long)); // The n array holds the number of data values belonging to each of the J groups or treatement levels.
    double *subsum = malloc(J * sizeof(double)); // The subsum array is used to hold the sum of the data in each of the J groups.
