/*
 * This file comes from the R project.
 * Currently, this file will simply be included by SmoothFilter.cpp
 * Adaption for Qtiplot:
 * Copyright (C) 2009 Jonas Bähr <jonas@fs.ei.tum.de>
 */
/*
