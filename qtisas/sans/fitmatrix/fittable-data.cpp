/***************************************************************************
 File                   : fittable-data.cpp
 Project                : QtiSAS
 --------------------------------------------------------------------
 Copyright              : (C) 2012-2021 by Vitaliy Pipich
 Email (use @ for *)    : v.pipich*gmail.com
 Description            : table(s) fitting interface: data tab functions
...
{
    if (tablePara->focusWidget()==0) return;
    if(raw!=tablePara->currentRow() && col!=tablePara->currentColumn()) return;
